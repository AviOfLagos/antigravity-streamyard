...
- Changelog: `src/app/(marketing)/changelog/page.tsx` (current: **v2.6.0**, live viewer counts + join pulses + lower-third name bars + PH launch kit + marketing funnel analytics).
