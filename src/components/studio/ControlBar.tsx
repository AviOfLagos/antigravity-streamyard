...
function TrackButton({ source, onIcon, offIcon, onLabel, offLabel }: TrackButtonProps) {
  ...
  return (
    <button
      ...
      className={[
        "flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-all text-[11px] font-medium min-w-[52px] select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2 focus-visible:ring-offset-studio-bg-deep",
        enabled
  ...
  return (
    <div className="flex items-center justify-center px-4 py-2 bg-studio-bg-deep border-t border-white/6 gap-2">
      ...
      <button
        ...
        disabled={recordBusy}
        className={[
          "flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-all text-[11px] font-medium min-w-[52px] select-none disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2 focus-visible:ring-offset-studio-bg-deep",
          isRecording
