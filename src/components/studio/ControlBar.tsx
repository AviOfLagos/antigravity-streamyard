...
function TrackButton({ source, onIcon, offIcon, onLabel, offLabel }: TrackButtonProps) {
  ...
  return (
    <button
      ...
      className={[
        "flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-all text-[11px] font-medium min-w-[52px] select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-studio-bg-deep",
        enabled
