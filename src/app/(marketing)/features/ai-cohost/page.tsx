  ...
  return (
    <div className="text-white selection:bg-indigo-500/30">
      ...
      <section className="relative px-6 pt-24 pb-20 max-w-7xl mx-auto overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_60%_40%_at_50%_0%,rgba(99,102,241,0.1),transparent)]" />
        <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-indigo-400 border border-indigo-500/20 rounded-full px-4 py-1.5 mb-12">
        ...
        <div className="flex items-center gap-8 border-t border-white/5 pt-10">
          ...
          <Link href="?beta=true" scroll={false} className="shrink-0 inline-flex items-center gap-2 bg-white text-neutral-950 font-bold px-7 py-3.5 rounded-full text-sm hover:bg-indigo-100 transition-all">
      ...
      <section className="border-t border-white/5 px-6 py-24 bg-neutral-950/40">
        <div className="max-w-7xl mx-auto">
          <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-16">Core capabilities</p>
          <div className="space-y-0">
            {[
              ...
              {
                icon: <MonitorPlay size={24} className="text-purple-400" />,
              ...
              {
                icon: <MessagesSquare size={24} className="text-blue-400" />,
              ...
              <div key={feat.title} className="flex flex-col md:flex-row gap-8 py-12 border-t border-white/5">
                <div className="md:w-64 shrink-0">
                  <div className="flex items-center gap-3 mb-2">
                    {feat.icon}
                    <span className="text-xs font-black text-neutral-700 tabular-nums">0{i + 1}</span>
                  </div>
                  <p className="font-bold text-white text-xl">{feat.title}</p>
                </div>
                <p className="text-neutral-500 text-base leading-relaxed max-w-2xl">{feat.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-5 gap-16 items-start">
          <div className="md:col-span-2">
            <p className="text-xs font-bold uppercase tracking-widest text-purple-400 mb-6">The Multichat Problem</p>
          ...
          <div className="md:col-span-3 space-y-0">
            {[
              ...
              <div key={i} className="flex items-center gap-6 py-5 border-t border-white/5">
                <span className="w-5 h-5 rounded-full bg-indigo-500/20 text-indigo-400 text-xs flex items-center justify-center font-bold shrink-0">✓</span>
