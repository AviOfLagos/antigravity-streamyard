...
const categories: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: <Bell className="w-4 h-4" />, name: "Join Pulses", detail: "Per-platform '+N new viewers' pills next to the header platform pills. Twitch + TikTok use native join events; YouTube + Kick infer a join from a viewer's first chat message. Never as a toast, never spammy.", status: "live" },
