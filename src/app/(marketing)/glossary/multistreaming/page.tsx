  ...
  return (
    <div className="text-white selection:bg-indigo-500/30">
      ...
      <section className="px-6 py-16 max-w-4xl mx-auto prose prose-invert prose-headings:font-black">
        ...
        <p className="text-neutral-400 leading-relaxed mb-4"><strong className="text-white">YouTube Live:</strong> Allowed for all creators.</p>
        <p className="text-neutral-400 leading-relaxed mb-4"><strong className="text-white">Twitch:</strong> Removed its exclusivity clause for non-Partners in 2022. Most Partners can now multistream as well, with some restrictions on simulcasting to other tier-1 platforms.</p>
        <p className="text-neutral-400 leading-relaxed mb-4"><strong className="text-white">Kick:</strong> No restrictions on multistreaming.</p>
        <p className="text-neutral-400 leading-relaxed mb-12"><strong className="text-white">TikTok Live:</strong> Allowed as long as you have a single TikTok account broadcasting. Multi-account simulcasting on TikTok is prohibited.</p>
