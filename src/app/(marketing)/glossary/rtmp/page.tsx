  ...
  return (
    <div className="text-white selection:bg-brand/30">
      ...
      <section className="px-6 py-16 max-w-4xl mx-auto">
        ...
        <pre className="bg-surface-2 border border-white/5 rounded-lg p-4 text-sm text-ink-emphasis mb-6 overflow-x-auto"><code>rtmp://a.rtmp.youtube.com/live2/abcd-1234-efgh-5678</code></pre>
