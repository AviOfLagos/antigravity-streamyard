  ...
  return (
    <div className="text-white selection:bg-indigo-500/30">
      ...
      <section className="px-6 pt-24 pb-20 max-w-7xl mx-auto">
        <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-8">Open Source</p>
      ...
      <section className="border-t border-white/5 px-6 py-24 bg-neutral-950/40">
        <div className="max-w-7xl mx-auto">
          <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-16">How to contribute</p>
            ...
            {[
              ...
              <div key={track.role} className="flex flex-col md:flex-row gap-8 py-12 border-t border-white/5">
                <div className="md:w-64 shrink-0">
                  <span className="text-xs font-black text-neutral-700 tabular-nums block mb-2">0{i + 1}</span>
                ...
                <div className="flex-1 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                  <p className="text-neutral-500 text-sm leading-relaxed max-w-xl">{track.desc}</p>
                  <Link
                    href={track.href}
                    scroll={false}
                    target={track.external ? "_blank" : undefined}
                    rel={track.external ? "noreferrer" : undefined}
                    className="shrink-0 inline-flex items-center gap-2 text-sm font-bold text-neutral-300 hover:text-white transition-colors group"
                  >
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-20">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-8">Guidelines</p>
          ...
          <div className="border-l border-white/5 pl-20">
            <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-8">Tech Stack</p>
