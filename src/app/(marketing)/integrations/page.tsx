  ...
  return (
    <div className="text-white selection:bg-indigo-500/30">
      ...
      <section className="px-6 pt-24 pb-20 max-w-7xl mx-auto">
        <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-8">Integrations</p>
        <h1 className="font-black text-white tracking-tight leading-[0.9] mb-12"
          style={{ fontSize: "clamp(52px, 9vw, 120px)" }}>
          Stream everywhere.<br />
          <span className="text-neutral-600">Reach everyone.</span>
        </h1>
        <p className="text-neutral-400 text-xl max-w-xl leading-relaxed border-l-2 border-white/10 pl-6">
      ...
      <section className="border-t border-white/5 px-6 py-24 bg-neutral-950/40">
        <div className="max-w-7xl mx-auto">
          <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-16">Supported platforms</p>
            ...
            {platforms.map((p, i) => (
              <div key={p.key} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 py-8 border-t border-white/5">
                <div className="flex items-center gap-6">
                  <span className="text-xs font-black text-neutral-700 tabular-nums shrink-0">0{i + 1}</span>
                  <PlatformIcon platform={p.key} size={28} />
                  <p className={`font-bold text-xl ${p.color}`}>{p.name}</p>
                </div>
                <p className="text-neutral-500 text-sm max-w-sm sm:text-right leading-relaxed">{p.detail}</p>
              </div>
            ))}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 py-8 border-t border-white/5">
              <div className="flex items-center gap-6">
                <span className="text-xs font-black text-neutral-700 tabular-nums shrink-0">05+</span>
                <div className="w-7 h-7 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-400 font-bold text-xs">R</div>
                <p className="font-bold text-xl text-neutral-400">Custom RTMP</p>
              </div>
              <p className="text-neutral-500 text-sm max-w-sm sm:text-right leading-relaxed">Facebook, LinkedIn, X, Vimeo, your own server — any RTMP destination works.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-16">Ways to go live</p>
        <div className="grid md:grid-cols-2 gap-0">
          <div className="pr-12 border-r border-white/5">
            ...
            <Link href="?beta=true" scroll={false} className="inline-flex items-center gap-2 text-indigo-400 hover:text-indigo-300 text-sm font-medium transition-colors">
          ...
          <div className="pl-12">
            ...
            <p className="text-neutral-600 text-sm">Available in Pro tier</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-white/5 px-6 py-20 bg-neutral-950/40">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-4">Unified Chat</p>
