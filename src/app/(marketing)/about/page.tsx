  ...
  return (
    <div className="text-white selection:bg-indigo-500/30">
      ...
      <section className="px-6 pt-24 pb-20 max-w-7xl mx-auto">
        <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-8">About Zerocast</p>
        <h1 className="font-black text-white tracking-tight leading-[0.95] mb-12"
          style={{ fontSize: "clamp(48px, 8vw, 104px)" }}>
          Broadcasting,<br />
          <span className="text-neutral-600">Automated.</span>
        </h1>
        <p className="text-neutral-400 text-xl max-w-xl leading-relaxed border-l-2 border-indigo-500 pl-6">
      ...
      <section className="border-t border-white/5 px-6 py-24 bg-neutral-950/40">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-8">Our Mission</p>
          ...
          <div className="space-y-6 text-neutral-500 text-sm leading-relaxed">
            <p>
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-16">What we stand for</p>
          ...
          {[
            ...
            <div key={title} className="flex gap-8 py-10 border-t border-white/5">
              ...
              <div>
                ...
                <p className="text-neutral-500 text-sm leading-relaxed max-w-xl">{desc}</p>
              </div>
            </div>
          ))}
        </div>
